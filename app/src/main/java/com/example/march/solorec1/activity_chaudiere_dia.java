...
public class activity_chaudiere_dia extends AppCompatActivity {
    ...
    private Button btnsuivcdia;
    private Button btnpreccdia;
    private Button btnretourcdia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsuivcdia=(Button) findViewById(R.id.button_suivcdia);
        btnpreccdia = (Button) findViewById(R.id.button_preccdia);
btnretourcdia = (Button) findViewById(R.id.button_retourcdia);
