...
public class activity_chaudiere_dim extends AppCompatActivity {
    ...
    private Button btnsuivchdim;
    private Button btnprecchdim;
    private Button btnretourchdim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsuivchdim = (Button) findViewById(R.id.button_suivchdim);
        ...
        btnretourchdim = (Button) findViewById(R.id.button_retourchdim);
