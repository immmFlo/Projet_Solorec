...
public class activity_debut_dec extends AppCompatActivity {
    ...
    private Button btnretourdebdec;
    private Button btnsuivdebdec;
private Spinner spinner3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnretourdebdec = (Button) findViewById(R.id.button_retourdebdec);
        ...
        btnsuivdebdec = (Button) findViewById(R.id.button_suivdebdec);
